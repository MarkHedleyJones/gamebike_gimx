/* Copyright (C) 2014 Kristian Lauszus, TKJ Electronics. All rights reserved.
 ...
 this file. Please note that GPL2 Section 2[b] requires thata ll works based
...
const uint8_t CHALLENGE_0[] = {
 0xf0, 0x01, 0x00, 0x00, 0xd8, 0x0f, 0xe7, 0xca, 0x90, 0x99, 0xa1, 0x71, 0xb2, 0x35, 0x7f, 0xad,
 0x08, 0x17, 0x6c, 0x6a, 0x81, 0xb9, 0xa1, 0xb5, 0xfe, 0x38, 0x43, 0x5d, 0x45, 0x40, 0xe8, 0xec,
 0xa7, 0x49, 0xa8, 0x8b, 0x91, 0x61, 0x4e, 0xfd, 0x12, 0xc9, 0xe0, 0x17, 0x36, 0x2b, 0x8a, 0xaf,
 0xc4, 0x58, 0x52, 0x5a, 0x27, 0xf5, 0x07, 0xce, 0xf5, 0xd3, 0x8b, 0xce, 0x5f, 0x21, 0xe1, 0xa9
};

const uint8_t CHALLENGE_1[] = {
 0xf0, 0x01, 0x01, 0x00, 0xf1, 0x29, 0x47, 0x02, 0x52, 0x5f, 0xe7, 0x47, 0xed, 0x5c, 0x1d, 0xd0,
 0x1b, 0x92, 0xae, 0x5d, 0xbc, 0x00, 0x81, 0x85, 0xde, 0xe6, 0xcc, 0x63, 0x2e, 0x9e, 0x1f, 0x55,
 0x4e, 0x2b, 0xb0, 0x87, 0x4f, 0x1e, 0x83, 0x6b, 0x7a, 0x94, 0x4d, 0xd8, 0x18, 0x5d, 0xbb, 0x81,
 0x97, 0x1e, 0x8c, 0x72, 0x7c, 0x91, 0xd6, 0x4f, 0xca, 0xa3, 0x21, 0x54, 0xe5, 0x8a, 0xc4, 0xc1
};

const uint8_t CHALLENGE_2[] = {
 0xf0, 0x01, 0x02, 0x00, 0x05, 0x3d, 0xef, 0xd2, 0xfa, 0xa3, 0xe1, 0xa3, 0x3a, 0x06, 0xe7, 0x0f,
 0xb7, 0xa2, 0x12, 0xfd, 0xc4, 0x1a, 0xeb, 0x9e, 0xd9, 0xc9, 0x09, 0x05, 0xf0, 0xb8, 0x01, 0xdc,
 0x7c, 0x29, 0x3c, 0x95, 0xd3, 0xd3, 0xfe, 0x80, 0xf2, 0x34, 0xe5, 0xd3, 0xe1, 0xb8, 0xb1, 0xc9,
 0x29, 0x63, 0x25, 0x52, 0x09, 0xf5, 0xa6, 0x79, 0x15, 0x0f, 0x38, 0x03, 0x9c, 0x64, 0xb2, 0xed
};

const uint8_t CHALLENGE_3[] = {
 0xf0, 0x01, 0x03, 0x00, 0x9d, 0x4d, 0x3c, 0xaf, 0x2c, 0x98, 0x45, 0x3d, 0xfe, 0x5c, 0xd1, 0x2f,
 0x4c, 0x3a, 0x5a, 0xd4, 0xf2, 0x87, 0x18, 0xcc, 0x07, 0x58, 0x0b, 0xe7, 0xe7, 0x0d, 0x2b, 0xf1,
 0x09, 0xac, 0xa0, 0xd9, 0xf3, 0xe3, 0x46, 0xdc, 0x4f, 0xc6, 0x30, 0x11, 0x8a, 0xb9, 0x1b, 0xb2,
 0x7a, 0x6b, 0x7c, 0x86, 0x5d, 0xdb, 0xef, 0x54, 0x08, 0x64, 0xc6, 0x3e, 0x49, 0xe2, 0xb8, 0xdb
};

const uint8_t CHALLENGE_4[] = {
 0xf0, 0x01, 0x04, 0x00, 0xb6, 0x16, 0xda, 0xfe, 0xf7, 0x3f, 0xae, 0x37, 0xb3, 0x54, 0x6b, 0x97,
 0x80, 0x5f, 0x39, 0xd9, 0xce, 0x9d, 0x26, 0x73, 0xce, 0x98, 0xf7, 0xe4, 0x8c, 0x6e, 0x51, 0x18,
 0xb2, 0xaa, 0xc0, 0x4e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2c, 0x38, 0x59, 0xd2
};
...
public:
  ...
  // void authenticate(uint8_t seq, uint8_t ep_number);
  void authenticate(uint16_t length, uint8_t* buff);
  void authenticate2(uint16_t length, uint8_t *data);
  void authenticate3(uint16_t length, uint8_t *data);
...
protected:
  ...
  // virtual void sendAuthRequest(uint8_t seq_num, uint8_t ep_number) = 0;
  virtual void sendAuthRequest(uint16_t length, uint8_t *data) = 0;
  virtual void receiveAuthRequest(uint16_t length, uint8_t *data) = 0;
  virtual void receiveAuthResponse(uint16_t length, uint8_t *data) = 0;
